...
let freeInstance = new form.FormValidate(freeForm,freeFormSubmit,freeFormInputs,false,null) ;
...
popupFormElm.querySelectorAll('.labelHandler').forEach(label => new form.LabelHandler(label)) ;
